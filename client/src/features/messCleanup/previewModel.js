  ...
  return {
    ...
    objects: placements.map((placement) => {
      ...
      return {
        ...
        worldPath: placement.worldPath || placement.path || source.worldPath || source.path || null,
        worldPathCommands: placement.worldPathCommands || placement.pathCommands || source.worldPathCommands || source.pathCommands || null,
        pathData: placement.pathData || (Array.isArray(placement.path) ? placement.path.map((c) => c.join(' ')).join(' ') : null) || source.pathData || source.connector?.pathData || null,
        pathCommands: placement.pathCommands || placement.path || source.pathCommands || source.connector?.pathCommands || null,
